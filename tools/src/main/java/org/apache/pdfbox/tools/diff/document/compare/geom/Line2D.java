...
import org.apache.pdfbox.tools.diff.document.compare.geom.Line2D.LineIntersection.Type;
...
public class Line2D {
	 ...
	 */
	public static final List<Vec2D> splitIntoSegments(Vec2D a, Vec2D b, float stepLength, List<Vec2D> segments,
			boolean addFirst) {
		if (segments == null) {
	...
	public boolean equals(Object obj) {
		...
		Line2D l = (Line2D) obj;
		return (a.equals(l.a) || a.equals(l.b)) && (b.equals(l.b) || b.equals(l.a));
	}
	...
	public LineIntersection intersectLine(Line2D l) {
		...
		float denom = (l.b.y - l.a.y) * (b.x - a.x) - (l.b.x - l.a.x) * (b.y - a.y);

		float na = (l.b.x - l.a.x) * (a.y - l.a.y) - (l.b.y - l.a.y) * (a.x - l.a.x);
		...
		if (denom != 0.0) {
			...
			if (na == 0.0 && nb == 0.0) {
				if (distanceToPoint(l.a) == 0.0) {
					...
					isec = new LineIntersection(Type.COINCIDENT_NO_INTERSECT, null);
				}
			} else {
